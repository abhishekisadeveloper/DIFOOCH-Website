...
const Ready = () => {
  return (
    <div className='flex flex-col items-center text-center gap-[30px] sm:gap-12 mb-12 sm:mb-[90px]'>
        ...
        <Button className='sm:w-[207px] h-[40px] sm:h-[64px] sm:text-heading-small3 rounded-[8px] hover:bg-accent2' variant='primary' icon='./HeroImagesAssets/rocket.svg'>Get Started</Button>
    </div>
  )
}
