export const Button = ({ variant = "primary", children, className, icon, iconWidth = "20", iconHeight = "20" }) => {
  ...
  const styles = {
    primary:
      "bg-accent text-black1 py-2 px-[18px] rounded-2xl sm:border-[1px] sm:border-primary sm:py-4 sm:px-6 text-small tracking-[0] font-bold font-family-jakarta",
    secondary:
      "bg-lightGreen px-[16px] py-2 w-full text-black1 rounded-[8px] text-small tracking-[0] font-bold font-family-jakarta",
    trialBtn:
