...
export const Typography = ({ variant = "p", children, className }) => {
  ...
  const styles = {
    ...
    h2: "leading-mobile-heading-medium text-mobile-heading-medium sm:text-heading-medium sm:leading-heading-medium tracking-[0px] font-jakarta font-bold text-black1",
